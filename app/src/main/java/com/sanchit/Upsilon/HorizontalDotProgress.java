...
public class HorizontalDotProgress extends View {
    //actual dot radius
    ...
    public void setDotPosition(int mDotPosition) {
        this.mDotPosition = mDotPosition;
    ...
    public void setDotAmount(int mDotAmount) {
        this.mDotAmount = mDotAmount;
    }

    public HorizontalDotProgress(Context context) {
        super(context);
    }

    public HorizontalDotProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizontalDotProgress(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int calculatedWidth = (2*(mBounceDotRadius+2)*mDotAmount);
    ...
    private void transitTo(int pos){
        mDotPosition = pos;
        BounceAnimation bounceAnimation = new BounceAnimation();
        bounceAnimation.setDuration(100);
        bounceAnimation.setInterpolator(new LinearInterpolator());
    ...
    private class BounceAnimation extends Animation {
        ...
        protected void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            //call invalidate to redraw your view aging.
            invalidate();
        }
    }
}
