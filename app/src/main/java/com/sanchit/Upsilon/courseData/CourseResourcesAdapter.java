...
public class CourseResourcesAdapter extends RecyclerView.Adapter<CourseResourcesAdapter.IntroductoryContentViewHolder> {
    ...
    public CourseResourcesAdapter(ArrayList<String> introductoryImages, ArrayList<String> introductoryVideos) {
    ...
    public IntroductoryContentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        CourseResourcesAdapter.IntroductoryContentViewHolder viewHolder = new CourseResourcesAdapter.IntroductoryContentViewHolder(view);
